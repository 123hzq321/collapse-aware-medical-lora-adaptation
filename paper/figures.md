...
flowchart LR
    ...
    B --> D["LoRA self-update<br/>seed 42 / 43 / 44"]
...
```mermaid
flowchart LR
    subgraph Before["Before self-update"]
...
- Avoid implying autonomous self-training. Label the mechanism as task-driven LoRA self-update.
